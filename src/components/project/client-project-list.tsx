...
export default function ClientProjectList({ initialProjects, initialRepos }: ClientProjectListProps) {
  const [githubProjects, setGithubProjects] = useState<any[]>(initialRepos || []);
